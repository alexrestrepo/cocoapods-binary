                    ...
                    if path_objects != nil
                        ...
                        path_objects.each do |object|
                            ...
                            if object.real_file_path.exist?
                                ...
                                Pod::UI.puts "!!! Ignoring missing file " + object.real_file_path.to_s
                            end
                        end
                    end
                end # of for each
    ...
    class Installer
        ...
        define_method(:resolve_dependencies) do
            ...
            prebuilt_specs.each do |spec|
                ...
                if spec.attributes_hash["resources"]
                    Pod::UI.puts "Resources: " + spec.attributes_hash["resources"].to_s
                end
